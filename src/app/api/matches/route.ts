...
// The functionality is available through the Pages Router API at /api/v1/matches
...
export async function GET() {
  return new Response(
    JSON.stringify({
      success: false,
      message: 'This API endpoint is temporarily disabled. Please use /api/v1/matches instead.',
      redirectTo: '/api/v1/matches'
    }),
    {
      status: 307,
      headers: {
